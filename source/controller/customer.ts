...
const addCustomer = async (req: Request, res: Response, next: NextFunction) => {
    ...
    return res.status(200).json({
        ...
        message: "successfully inserted customer data"
    });
};



export default { getCustomers,getCustomer,updateCustomer,deleteCustomer,addCustomer};