...
const getSuppliers = async(req:Request,res:Response,next:NextFunction)=>{
    let result:any[] = await (await connection ).query(`select * from [ecommerce].[dbo].[Supplier]`);
...
const getSupplier= async(req:Request,res:Response,next:NextFunction)=>{
    ...
    let id = req.params.id;
        ...
        let result:any[] = await(await connection).query(`select * from [ecommerce].[dbo].[Supplier] where Id=${id}`);
...
const updateSupplier = async(req:Request,res:Response,next:NextFunction)=>{
    ...
    let result:any[] = await(await connection).query(`select top (1) * from [ecommerce].[dbo].[Supplier] where Id=${id}`);
    ...
    if(result.length){
        ...
        let query_response = await(await connection).query(`update [ecommerce].[dbo].[Supplier] 
        ...
        let updated_data = await(await connection).query(`select * from [ecommerce].[dbo].[Supplier] where id=${id}`);
...
const deleteSupplier = async(req:Request,res:Response,next:NextFunction)=>{
    ...
    let result = await(await connection).query(`delete from [ecommerce].[dbo].[Supplier] where Id=${id}`);
...
const addSupplier = async(req:Request,res:Response,next:NextFunction)=>{
    ...
    let result = await(await connection).query(`insert into [ecommerce].[dbo].[Supplier] ([CompanyName],[contactName],[ContactTitle],[City],[Country],[Phone],[Fax])Values('${CompanyName}','${ContactName}','${ContactTitle}','${City}','${Country}','${Phone}','${Fax}')`);
